...
// CustomerInteractionNote 顧客との接点履歴
type CustomerInteractionNote struct {
...
type Customer struct {
	...
	CustomerStatus     string                    `json:"customer_status" firestore:"customer_status"`
	Tags               []string                  `json:"tags" firestore:"tags"`
	VIPRank            int                       `json:"vip_rank" firestore:"vip_rank"`
	LTVScore           float64                   `json:"ltv_score" firestore:"ltv_score"`
	LifetimeValue      float64                   `json:"lifetime_value" firestore:"lifetime_value"`
	LastInteractionAt  *time.Time                `json:"last_interaction_at" firestore:"last_interaction_at"`
	InteractionNotes   []CustomerInteractionNote `json:"interaction_notes" firestore:"interaction_notes"`
	PreferredChannel   string                    `json:"preferred_channel" firestore:"preferred_channel"`
	LeadSource         string                    `json:"lead_source" firestore:"lead_source"`
	Notes              string                    `json:"notes" firestore:"notes"`
	Occupation         string                    `json:"occupation" firestore:"occupation"`
	AnnualIncomeRange  string                    `json:"annual_income_range" firestore:"annual_income_range"`
	PreferredArchetype string                    `json:"preferred_archetype" firestore:"preferred_archetype"`
	DiagnosisCount     int                       `json:"diagnosis_count" firestore:"diagnosis_count"`
	CreatedAt          time.Time                 `json:"created_at" firestore:"created_at"`
	UpdatedAt          time.Time                 `json:"updated_at" firestore:"updated_at"`
}
